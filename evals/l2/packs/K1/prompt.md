`y` in data.csv is a sample from a two-component process.

Name the two component locations `mu1` and `mu2` and the share of
the first component `weight` in the saved posterior.
